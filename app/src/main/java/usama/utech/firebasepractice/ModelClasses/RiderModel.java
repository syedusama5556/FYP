...
public class RiderModel {
     String uid;
     String email,status,reported,fullname,cnicno,phoneno,provence,city,designetion
            ,age,online,gender,verified,currentlogitude,currentlatitude,profileimageurl;
